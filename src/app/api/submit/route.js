...
export async function POST(request) {
  try {
    ...
    const docenteData = {
      ...
      paisPago: fields.paisPago,
      monedaPago: fields.monedaPago,
      bancoNombre: fields.bancoNombre,
      titularCuenta: fields.titularCuenta,
      detallesPagoExtra: fields.detallesPagoExtra,
